...
function displayAvailableTimes(res) {
  res.writeHead(200, { "Content-Type": "application/json" });
  res.write(JSON.stringify(availableTimes));
  res.end();
}
...
console.log(pathname);
  ...
  default:
   if (pathname === "/") {
     sendFile("./public_html/index.html", res);  // Serve the homepage
   } else {
     sendFile("./public_html" + pathname, res);  // Serve other static files
   }
   break;
  }
});
